...
# 1        2           3            4
producerList = []
ColorList = ['green', 'red', 'blue', 'yellow', 'white', 'magenta', 'black', 'cyan', 'orchid', 'tan', 'violet', 'plum_2',
             'honeydew_2', 'pink_1', 'indian_red_1a', 'sky_blue_2', 'light_sky_blue_3a', 'dark_sea_green_3a']
...
if alternance == 0:
    ...
    try:
        ...
        for i in compradores:
            print("A")
            consumer = ConsumerThread(i.idC, i.low, i.high, ColorList[color])
            color = color + 1
            print("B")
