...
ProducerThread(name='white', daemon=True).start()
ProducerThread(name='black', daemon=True).start()
ProducerThread(name='light_red', daemon=True).start()
ProducerThread(name='light_green', daemon=True).start()
ProducerThread(name='grey_0', daemon=True).start()
